...
D = 'D'
a = [name.name for name in humans if name.name[0].upper() == "D"]
print(a)

# Write a list comprehension that creates a list of names of everyone
# whose name ends in "e".
print("Ends with e:")
b = [name.name for name in humans if name.name[-1].lower() == 'e']
print(b)
...
c = [name.name for name in humans if name.name[0].upper() >=
     "C" and name.name[0].upper() <= "G"]
print(c)
